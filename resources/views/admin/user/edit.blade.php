            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="card-body">
                      ...
                      <!--<div class="form-group">-->
                      <!--      {!! Form::label(' Wallet Money') !!}-->
                      <!--      <input class="form-control" value="{{$user->user_wallet_money}}" readonly>-->
                            
                      <!--  </div>-->
                      <!--  <div class="form-group">-->
                      <!--      {!! Form::label('Add Wallet Money') !!}-->
                      <!--      <input type="number" name="user_wallet_money" class="form-control" >-->
