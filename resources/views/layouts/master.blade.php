...
<head>
    ...
    <title>@yield('title', 'OPEN LIBRARY - Home')</title>
    <!-- Favicon icon -->
...
<section class="header py-2 bg-dark">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="headings">
                    <h3><a href="{{route('bookshop.home')}}" class="text-secondary"><b class="text-danger">OPEN</b> LIBRARY</a></h3>
                </div>
            </div>
            <div class="col-md-4">
...
<footer class="py-3 text-center border-top bg-light">
    <div class="container">
        ...
        <div class="footer-text">
            Copyright: &copy; OPEN LIBRARY Management System. All Right Reserved. <span id="year"></span>
        </div>
        <div class="social-icon mt-2">
        <span class="mr-2">
          <a href="https://www.facebook.com/hasanulkabir.utsho/" class="text-primary"><i class="fab fa-facebook fa-2x"></i></a>
        </span>
            <span class="mr-2">
          <a href="https://github.com/utshopust" class="text-secondary"><i class="fab fa-github fa-2x"></i></a>
        </span>
            <span class="mr-2">
