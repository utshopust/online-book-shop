...
class CheckoutController extends Controller
{
    ...
    public function pay(Request $request)
    {
      ...
      if($request->cart_total <= Auth::user()->user_wallet_money){
...
$id = Auth::user()->id;
$user=User::find($id);
$user->user_wallet_money -=$request->cart_total;
$user->save();
    ...
    return back()->with('succes_message', 'Your Wallet Ammount not sufficient');
}
