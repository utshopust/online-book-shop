...
Route::get('/pdf/download/{id}', 'BookshopHomeController@download');
...
Route::post('/review/submit', 'ReviewsController@review');
...
Route::group(['middleware' => 'admin'], function (){
    ...
    Route::get('money/index', 'Admin\AdminBooksController@money')->name('money.index');
    Route::get('money/create', 'Admin\AdminBooksController@moneycreate')->name('money.create');
    Route::get('money/edit/{id}', 'Admin\AdminBooksController@moneyedit')->name('money.edit');
    Route::post('money/store', 'Admin\AdminBooksController@moneystore')->name('money.store');
    Route::DELETE('money/destroy/{id}', 'Admin\AdminBooksController@moneydestroy')->name('money.destroy');
...
Route::group(['middleware' => 'user'], function (){
    ...
    Route::post('/user/add/money', 'Users\UserOrdersController@addmoney');
